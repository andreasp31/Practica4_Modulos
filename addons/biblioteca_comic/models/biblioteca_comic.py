...
class BibliotecaComic(models.Model):
    ...
    paginas = fields.Integer('Numero de páginas',
        #Hace que este atributo este disponible para este grupo de seguridad que son todos los usuarios
    ...
    #Cada vez que se cambie ese atributo, se lanzara esta funcion
