...
Luego quise hacer un menú arriba en el archivo de la vista de "liga partido" bueno un header pero esa etiqueta funciona con "tree" y no con "list" así que la única manera que encontré es añadir los botones a la lista de los partidos, cumplen su función pero no es que sea lo más estético.
...
\begin{lstlisting}[style=javascript]
    ...
    <record id="liga_partido_view_list_nueva" model="ir.ui.view">
        ...
        <field name="arch" type="xml">
            <list>
                <button name="sumar_goles_locales" string="+2 Goles Locales" type="object"/>
                <button name="sumar_goles_visitantes" string="+2 Goles Visitantes" type="object"/>
...
\vspace{0.2cm}
\begin{center}
    \includegraphics[height=4.8cm]{images/futbol7.png}
\end{center}
...
\vspace{0.2cm}
\begin{center}
    \includegraphics[height=4.8cm]{images/futbol8.png}
\end{center}
...
El objetivo de este apartado es crear un partido mediante un formulario emergente que guarda datos temporales. Para crear un Wozard hay que generar un modelo nuevo "partido wizard".
