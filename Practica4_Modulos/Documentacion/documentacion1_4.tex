...
<odoo>
    ...
    <!-- Simple menu item, sin mas utilidad que la didactica -->
    <menuitem name="Hospital Central" id="hospital_base_menu" />
...
<odoo>
    ...
    <!-- Definir de la vista busqueda-->
    <record id="hospital_medico_view_search" model="ir.ui.view">
